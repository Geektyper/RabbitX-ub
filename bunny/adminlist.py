...
@Client.on_message(filters.me & filters.command(["admins", "adminlist"], hl))
...
@Client.on_message(filters.command(["kickdel", "zombies"], hl) & filters.me)
async def kickdel_cmd(client: Client, message: Message):
    Geek = await edit_or_reply(message, "<b>Kicking deleted accounts...</b>")
    ...
    await Geek.edit(f"<b>Successfully kicked {len(values)} deleted account(s)</b>")


@Client.on_message(
    filters.me & filters.command(["reportadmin", "reportadmins", "report"], hl)
)
...
@Client.on_message(filters.me & filters.command(["everyone", "tagall"], hl))
...
@Client.on_message(filters.me & filters.command(["botlist", "bots"], hl))
